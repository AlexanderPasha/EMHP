...
public class Dashcoin extends Coin {
    private static final double KOMSA = 0.002;
    private static final String RUB = "RUB";
    private static final String USD = "USD";
    private static final String BTC = "BTC";

    public Dashcoin(Pair dashBtc, Pair dashUsd, Pair dashRub, Pair usdRub,Pair btcUsd) {
        super("DASH",dashBtc,dashUsd,dashRub,usdRub,null,null,null,null,null,null,null,btcUsd,null,null,null,null);
