...
public class Storiqa extends Coin {
    private static final double KOMSA = 0.002;
    private static final String RUB = "RUB";
    private static final String USD = "USD";
    private static final String BTC = "BTC";

    public Storiqa(Pair ltcBtc, Pair ltcUsd, Pair ltcRub, Pair usdRub, Pair ltcEur, Pair btcUsd) {
        super("STQ",ltcBtc,ltcUsd,ltcRub,usdRub,null,ltcEur,null,null,null,null,null,btcUsd,null,null,null,null);
