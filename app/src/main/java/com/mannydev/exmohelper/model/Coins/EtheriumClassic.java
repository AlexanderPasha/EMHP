...
public class EtheriumClassic extends Coin {
    private static final double KOMSA = 0.002;
    private static final String RUB = "RUB";
    private static final String USD = "USD";
    private static final String BTC = "BTC";

    public EtheriumClassic(Pair etcBtc, Pair etcUsd, Pair etcRub, Pair usdRub, Pair btcUsd) {
        super("ETC",etcBtc,etcUsd,etcRub,usdRub,null,null,null,null,null,null,null,btcUsd,null,null,null,null);
