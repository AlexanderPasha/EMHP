...
public class ZecCoin extends Coin {
    ...
    public ZecCoin(Pair zecBtc, Pair zecUsd, Pair zecRub, Pair usdRub, Pair zecEur,Pair btcUsd) {
        super("ZEC",zecBtc,zecUsd,zecRub,usdRub,null,zecEur,null,null,null,null,null,btcUsd,null,null,null,null);
