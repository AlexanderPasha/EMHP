...
public class Litecoin extends Coin {
    ...
    public Litecoin(Pair ltcBtc, Pair ltcUsd, Pair ltcRub, Pair usdRub, Pair ltcEur, Pair btcUsd) {
        super("LTC",ltcBtc,ltcUsd,ltcRub,usdRub,null,ltcEur,null,null,null,null,null,btcUsd,null,null,null,null);
